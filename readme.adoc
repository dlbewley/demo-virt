...
Generate the link:networking[networking/] resouces for application.
...
Maybe take a peek at this link:networking/diagram.md[networking diagram] for a sense of how the pieces will fit together.
